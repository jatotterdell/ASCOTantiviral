...
make_subgroup_iatrogenic_table()
```
...
ggsave(
  file.path("outputs", "figures", "outcomes", "primary", "fas-itt-subgroup-country2-hte.pdf"),
  p, height = 3, width = 6, device = cairo_pdf)
p
```
...
<!--   mutate( -->
<!--     Subgroup = "Age", -->
<!--     Variable = factor(agegte60, labels = sgroup_labs_shrt$Age), -->
<!--     Intervention = as.character(factor( -->
<!--       AAssignment, -->
